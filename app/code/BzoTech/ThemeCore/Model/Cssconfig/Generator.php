<?php
namespace BzoTech\ThemeCore\Model\Cssconfig;
...
class Generator
{
    ...
    public function __construct(
        \BzoTech\ThemeCore\Helper\Cssconfig $cssconfigData,
    ...
    protected function generateStoreCss($type, $storeId) {
        ...
        try {
            $block = $this->_layoutManager->createBlock('BzoTech\ThemeCore\Block\Template')->setData('area','frontend')->setTemplate($str4)->toHtml();
